...
class kinesiologo (models.Model):
    ...
    precio_consulta = models.DecimalField(
        ...
        decimal_places=0,
        default=25000,
        help_text="Precio de la consulta en pesos chilenos"
    )
    
    # Modalidades de atención
    atiende_consulta = models.BooleanField(
        default=True,
        help_text="Atiende en consulta/box propio"
    )
    atiende_domicilio = models.BooleanField(
        default=False,
        help_text="Realiza atención a domicilio"
    )
    
    # Ubicación (para consulta presencial)
    direccion_consulta = models.CharField(
        max_length=500,
        blank=True,
        null=True,
        help_text="Dirección de la consulta o box"
    )
    comuna = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        help_text="Comuna donde atiende"
    )
    region = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        help_text="Región donde atiende"
    )
    ...
    class Meta:
        indexes = [
            models.Index(fields=['precio_consulta']),
